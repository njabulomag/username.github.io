...
import { Brain, Shield, User, LogOut, Settings, Download } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ onOpenAccessibility }) => {
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-emerald-500 rounded-full flex items-center justify-center">
                  <Shield className="text-white" size={12} aria-hidden="true" />
                </div>
              </div>
              <div>
                ...
                {user ? (
                  <div>
                    <button
                      ...
                      className="flex items-center space-x-2 p-2 rounded-lg hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    {showUserMenu && (
                      <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50">
                        ...
                        <button
                          ...
                          className="w-full flex items-center space-x-2 px-4 py-2 text-left hover:bg-slate-50 transition-colors focus:outline-none focus:bg-slate-50"
                        >
                  ...
                  <button
                    ...
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    Sign In
                  </button>
                )}
